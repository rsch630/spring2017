...
`Deliverable` <- c("Thesis Presentation",
                   "Research Method Presentation",
                   "Thesis Outline", 
                   "Final Exam")
`Grade Weight` <- rep('25%', 4)
knitr::kable(data.frame(`Deliverable`, `Grade Weight`))
```
...
source('rsch-630-schedule.R', print.eval = T)
```
